...
from .Converter import Converter, Value
...
class CharIO:
    ...
    def getFeatures(actionDict: dict[str, Action], bonusDamageDict: dict[str, BonusDamage]) -> dict[str, Feature]:
        neededFeatures = dict[tuple[str], list[tuple[str, list[tuple[str, Value]], list[tuple[str, list[Value]]], list[tuple[str, list[str]]], list[Action], list[BonusDamage]]]]()
        needed: list[tuple[str, list[tuple[str, Value]], list[tuple[str, list[Value]]], list[tuple[str, list[str]]], list[Action], list[BonusDamage]]]
    ...
    def getBonusDamageSources() -> dict[str, BonusDamage]:
        bonusDamage = dict[str, BonusDamage]()
    ...
    def getSettings() -> list[Union[int, bool]]:
        args: list[int | bool]
